...
public class ArtOfMeleeCard : MonoBehaviour
{
  public GameObject UglinessOfMeleeCard;
  ...
  private void GenericCard_OnSuggestion(bool right)
  {
    ...
    {
      GameMananger.Instance.SuggestNewArmor(GameMananger.Instance.Armor - 40);
    }
  }
  ...
  private void GenericCard_OnSwipe(bool right, bool revealsFoW)
  {
    ...
    if (right)
    {
      ...
      GameMananger.Instance.EnqueueCards(new[] { UglinessOfMeleeCard });
    }
    else
    {
      GameMananger.Instance.Armor -= 40;
      GameMananger.Instance.EnqueueCards(new[] { UglinessOfMeleeCard });
    }
  }
}
