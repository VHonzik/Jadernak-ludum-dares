...
namespace Game.Commands
{
    class ListSociety : ICommand
    {
        ...
        public ParsingResult Parse(string line)
        {
            ...
            {
                GameManager.Instance.Society.ListSociety();
            }
        ...
        public void PrintManPage()
        {
            ...
            GConsole.WriteLine(-1.0f,
                GConsole.ColorifyText(1, "Prints the list of society members, their titles and known weakness or strenghts."));
            GConsole.WriteLine(" ");
        }
    }
}
