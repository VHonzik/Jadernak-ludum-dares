...
namespace LD45
{
  ...
  const char kAppName[] = "Start With No Dice";
  ...
  const Style kEngineStyle =
  {
    ...
    //std::vector<std::tuple<std::string, std::string, bool>> textures;
    {
      ...
      { "greenButton", "assets/green_button09.png", false},
      { "greenButtonPressed", "assets/green_button10.png", false},
      ...
      { "dice", "assets/dice.png", false},
      { "diceGGlow", "assets/dice_gglow.png", false},
      { "diceYGlow", "assets/dice_yglow.png", false},
      { "diceRGlow", "assets/dice_rglow.png", false},
      { "diceBGlow", "assets/dice_bglow.png", false},
      { "upgrade", "assets/upgradeside.png", false},
      { "upgradeGGlow", "assets/upgradeside_gglow.png", false},
      { "upgradeYGlow", "assets/upgradeside_yglow.png", false},
      { "oneGold", "assets/1gold.png", false},
      { "twoGold", "assets/2gold.png", false},
      { "threeGold", "assets/3gold.png", false},
      { "oneVP", "assets/1vp.png", false},
      { "threeVP", "assets/3vp.png", false},
      { "sixVP", "assets/6vp.png", false},
      { "zzz", "assets/zzz.png", false},
      { "reroll", "assets/reroll.png", false},
      { "trash", "assets/trash.png", false},
      { "upgold", "assets/upgold.png", false},
      { "endScreenBg", "assets/endScreenBg.png", false},
      { "endScreenDefeat", "assets/endScreenDefeat.png", false},
      { "endScreenVictory", "assets/endScreenVictory.png", false},
    },
    ...
    //std::vector<std::pair<std::string, std::string>> sounds;
    {
      ...
      { "cashRegister", "assets/CashRegister.wav"},
    },
