...
namespace LD45
{
  ...
  bool Settings::ReadSettings()
  {
    ...
    if (buildMajor != kBuildMajorVersion || buildMinor != kBuildMinorVersion)
    {
      return false;
    }
  ...
  bool Settings::WriteSettings()
  {
    ...
    fs << SettingsComment << " " << kAppName << " settings file. Modify at your own risk." <<
    ...
    fs << kBuildMajorVersion << kBuildSeperator <<
      kBuildMinorVersion << kBuildSeperator << kBuildHash << std::endl;
